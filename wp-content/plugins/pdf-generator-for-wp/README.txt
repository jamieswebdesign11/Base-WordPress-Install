...
**2) Control The Dispaly Of Functionality**
...
We have already provided the shortcode. You can use that shortcode to place the PDF button on a particular product page so you can generate PDF from page.
