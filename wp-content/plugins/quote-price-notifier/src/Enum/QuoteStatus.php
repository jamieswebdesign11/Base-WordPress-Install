...
/**
 * Available values for Quote Request status
 */
abstract class QuoteStatus {
	...
	public static function getLabels() {
		if (is_null(self::$labels)) {
			self::$labels = [
				self::PENDING  => __('Pending', 'quote-price-notifier'),
				self::RESOLVED => __('Resolved', 'quote-price-notifier'),
			];
		}
		return self::$labels;
	}
	...
	/**
	 * Determines whether given value is a valid Quote Request status
	 *
	 * @param string $value
	 * @return bool
	 */
